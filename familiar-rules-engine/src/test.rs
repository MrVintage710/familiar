...
use crate::{error::VreResult, feature::Feature, lua::run_file_with_lua, object::Object, rulebook::Rulebook, stat::{field::{StatBlockField, StatSourceProvider}, statblock::StatBlock, value::StatValue}, test};
...
fn feature_setup() {
    ...
    assert_eq!(input.choice_count(), 1);
    input.set_choice("Test", 0);
    println!("{input:?}");
